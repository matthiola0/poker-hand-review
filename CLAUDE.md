...
`web/` is a static SPA that reads a JSON report. `tools/` holds the TexasSolver adapter and `import_mtt_preflop_charts.py`, which wires the MTT preflop range charts into `gto/charts/`.
